...
export default function ImageMaskGallery({ images = [], onImageClick }) {
  /* Take up to 9 images */
  const displayImages = images.slice(0, 9)

  return (
    <div className="image-mask-gallery">
      ...
      <div className="mask-grid">
        {displayImages.map((img, i) => (
          <figure
            ...
            style={{ clipPath: clipPaths[i] || clipPaths[0] }}
